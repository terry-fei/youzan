...
var querystring = require('querystring'); //FIX
...
API.prototype.get = function(method, apiParams, callback) {
  var params = this.buildRequestParams(method, apiParams);
  var _params = {};
    params.forEach(function(item) {
        _params[item.name] = item.value;
    });
  var url = this.prefix + '?' + querystring.stringify(_params);
  var opts = {
    method: 'GET',
    dataType: 'json',
    timeout: 3000
...
API.prototype.buildRequestParams = function(method, apiParams) {
  var params = [];
